...
black src
```
'@ | Set-Content -LiteralPath (Join-Path $pyRoot "README.md") -Encoding UTF8
...
## Lint e formatação (se configurar ESLint/Prettier)
```powershell
npm run lint
npm run format
```
'@ | Set-Content -LiteralPath (Join-Path $jsRoot "README.md") -Encoding UTF8
...
npm test
```
'@ | Set-Content -LiteralPath (Join-Path $tsRoot "README.md") -Encoding UTF8
...
gdb app.exe
```
'@ | Set-Content -LiteralPath (Join-Path $cRoot "README.md") -Encoding UTF8
